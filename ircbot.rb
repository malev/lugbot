    ...
    def handle_server_input(s)
        ...
        case s.strip
            ...
            when /^:(.+?)!(.+?)@(.+?)\sPRIVMSG\s.+\s:[\001]PING (.+)[\001]$/i
                ...
                #send ":elboton!n=elboton@host48.190-31-103.telecom.net.ar PRIVMSG #lugtucuman :hola mundo soy un boton!"
...
irc = IRC.new('irc.freenode.net', 6667, 'elbotboton', '#lugtucuman')
irc.connect()
begin
    irc.main_loop()
rescue Interrupt
...
=begin
:malev!n=malev@host48.190-31-103.telecom.net.ar PRIVMSG #lugtucuman :elbotboton: hoola loco
:malev!n=malev@host48.190-31-103.telecom.net.ar PRIVMSG elbotboton :hhhhhhhhhhhhhh
=end
